...
from src.tools.point_cloud_generator import make_points, get_distance_matrix, make_point_cloud_plot, get_coord_matrix
...
def main():
    ...
    kml_filepath = r"C:\Users\corde\Documents\Python\preflight_post_processing_app\src\tests\test_data.kml"
    height = 4.5  # meters
    spacing = 10  # meters
